    ...
    <div className='grid grid-cols-1 sm:grid-cols-2 h-screen w-full'>
      ...
      <div className='bg-gray-700 flex flex-col justify-center'>
        <form className='max-w-[400PX] w-full mx-auto bg-gray-800  p-8 px-8  rounded-lg'>
          ...
          <button onClick={handleRegister} className='w-full my-2 py-2 bg-teal-800 shadow-lg shadow-teal-500/20 text-white font-semibold rounded-lg'>Se connecter</button>
